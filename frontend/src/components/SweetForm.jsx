...
export const SweetForm = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "bg-white dark:bg-gray-800 rounded-xl shadow-xl dark:shadow-gray-900/50 p-6 mb-8 border border-gray-200 dark:border-gray-700"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl font-bold mb-6 text-gray-800 dark:text-gray-100"
  }, "Add New Sweet"), /*#__PURE__*/React.createElement("form", {
  ...
  }, "Create Sweet"), /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: onCancel,

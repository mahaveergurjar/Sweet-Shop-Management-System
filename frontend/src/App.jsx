...
function App() {
  ...
  return /*#__PURE__*/React.createElement(Router, null, /*#__PURE__*/React.createElement("div", {
    ...
    path: "/",
    element: /*#__PURE__*/React.createElement(ProtectedRoute, null, user && user.isAdmin ? /*#__PURE__*/React.createElement(Navigate, {
      to: "/admin",
      replace: true
    ...
    path: "/purchases",
    element: /*#__PURE__*/React.createElement(ProtectedRoute, null, /*#__PURE__*/React.createElement(PurchaseHistory, null))
  }))));
}
export default App;